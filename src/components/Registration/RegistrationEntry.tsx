    ...
    >
      ...
      <div className="entry-cards-container">
        ...
        >
          ...
          <span className="entry-title">{t.gameEntryTitle}</span>
          <span className="entry-desc">{t.gameEntryDesc}</span>
        </button>
        ...
        >
          ...
          <span className="entry-title">{t.bagEntryTitle}</span>
          <span className="entry-desc">{t.bagEntryDesc}</span>
        </button>
